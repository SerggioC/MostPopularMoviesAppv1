...
class MovieObject1 implements Parcelable {
    ...
    public MovieObject1(Integer vote_count, Integer id, Boolean video, Float vote_average, String title, Float popularity, String poster_path, String original_language, String original_title, int[] genre_ids, String backdrop_path, Boolean adult, String overview, String release_date) {
    ...
    protected MovieObject1(Parcel in) {
